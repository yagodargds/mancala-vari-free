package rf.yagodar.manqala.drawing.view;
...
import rf.yagodar.manqala.drawing.model.ManqalaVariGameBoardModel;
import rf.yagodar.manqala.drawing.model.ManqalaVariPausePlateModel;
	...
	private void buildCellsBackDropsOnGameBoard(TypedArray sVProperties, ManqalaCombatVariSVBlank sVBlank, float sVLevelZ, float sVWidth, float sVHeight) {
		if(sVBlank.getGameBoardModel() != null) {	
			...
			PolygonInfo firstWarehousePolygonInfo = Util.insideLocatePolygonCenterCenter(	availableWarehouseLeftX, 
					...
					availableCellWidth * cellVWarehouseXMult - borderCellVCellX / 2.0f, 
			...
			if(firstWarehousePolygonInfo != null) {
				...
				float availableCellLeftX = availableWarehouseLeftX + firstWarehousePolygonInfo.getWidth() + borderCellVCellX;				
